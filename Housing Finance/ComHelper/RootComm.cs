...
namespace Housing_Finance.ComHelper
{
    ...
    public class RootComm
    {
        ...
        /// 
        /// </summary>
        public List<Room_Type_listItem> Room_Type_list { get; set; }
        /// <summary>
        /// 
        /// </summary>
    ...
    //每一层上的所有房间
    public class Room_Type_listItem
    {
    ...
    public class MsgRp_Expd_Inf_Set
    {
        public string iconClass { get; set; }
        public string content { get; set; }

    }
    public class HsPty_AftEqmt_StnDsc
    {
        [JsonProperty("class")]
